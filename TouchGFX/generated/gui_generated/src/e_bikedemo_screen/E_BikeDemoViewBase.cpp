...
void E_BikeDemoViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    {
        //GoBackToMenu
        //When backButton clicked change screen to E_BikeDemo
        //Go to E_BikeDemo with screen transition towards South
        application().gotoE_BikeDemoScreenWipeTransitionSouth();
    }
}
