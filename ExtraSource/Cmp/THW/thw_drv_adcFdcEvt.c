...
const char thw_drv_adcFdcEvt_menuName[] = "Driver | ADC/FDC/EVT";


//-------------------------
static void thw_drv_adcFdcEvt_startStop(void);
static void thw_drv_adcFdcEvt_toggleVref(void);
static void thw_drv_adcFdcEvt_toggleDepExt1(void);
static void thw_drv_adcFdcEvt_toggleDepExt2(void);
static void thw_drv_adcFdcEvt_toggleDepInt(void);
static void thw_drv_adcFdcEvt_dep1_setOffset(void);
static void thw_drv_adcFdcEvt_toggleTempExt1(void);

st_thw_menuItem thw_drv_adcFdcEvt_menuTab[] = {
		{.name = "ADC       :  start/stop",							.pActionFn = thw_drv_adcFdcEvt_startStop, 		.info = 0},
		{.name = "ADC       :  Vref Int/Ext",						.pActionFn = thw_drv_adcFdcEvt_toggleVref, 		.info = 0},
		{.name = "Dep Ext 1 :  \"4-20mA\"/\"0-5V K\"\"0-5V P\"",	.pActionFn = thw_drv_adcFdcEvt_toggleDepExt1, 	.info = 0},
		{.name = "Dep Ext 2 :  \"4-20mA\"/\"0-5V K\"\"0-5V P\"",	.pActionFn = thw_drv_adcFdcEvt_toggleDepExt2, 	.info = 0},
		{.name = "Dep Int   :  \"Nxp\"/\"HoneyWell\"",				.pActionFn = thw_drv_adcFdcEvt_toggleDepInt, 	.info = 0},
		{.name = "Dep Int   :  Set offset",							.pActionFn = thw_drv_adcFdcEvt_dep1_setOffset, 	.info = 0},
		{.name = "Temp Ext1 :  \"NTC\"/\"PT1000\"",					.pActionFn = thw_drv_adcFdcEvt_toggleTempExt1,	.info = 0},
};
uint16_t thw_drv_adcFdcEvt_menuTabSize = sizeof(thw_drv_adcFdcEvt_menuTab) / sizeof(st_thw_menuItem);


static void thw_drv_adcFdcEvt_DisplayMenu(void);
static void thw_drv_adcFdcEvt_ManageChoice(char CodeToManage);
static void thw_drv_adcFdcEvt_RefreshFn(void);

//------------------------------------------------------------------------------
// DESCRIPTION:         void thw_drv_adcFdcEvt_setActive(void)
// PARAMETERS:          void
// RETURN VALUE:        void
// DESIGN INFORMATION:
//------------------------------------------------------------------------------
void thw_drv_adcFdcEvt_setActive(void)
{
	DRVADC_init();
	...
	// Menu affiché
	thw_actualMenu.displayMenu = 		thw_drv_adcFdcEvt_DisplayMenu;
	thw_actualMenu.manageChoiceFn = 	thw_drv_adcFdcEvt_ManageChoice;
	thw_actualMenu.refreshFn = 			thw_drv_adcFdcEvt_RefreshFn;
...
//*************************************************************************************************
//------------------------------------------------------------------------------
/// \fn 		void thw_drv_adcFdcEvt_DisplayMenu(void)
/// \brief
//------------------------------------------------------------------------------
static void thw_drv_adcFdcEvt_DisplayMenu(void)
{
	...
	// Affichage Menu
	THW_Banner(thw_drv_adcFdcEvt_menuName);
	THW_printf("\r\n");
	...
	// Affichage du menu
	THW_printf("Menu\r\n");
	THW_displayActionMenu(thw_drv_adcFdcEvt_menuTab, thw_drv_adcFdcEvt_menuTabSize);

}

//------------------------------------------------------------------------------
/// \fn 		void thw_drv_adcFdcEvt_ManageChoice(char CodeToManage)
/// \brief
//------------------------------------------------------------------------------
static void thw_drv_adcFdcEvt_ManageChoice(char CodeToManage)
{
	// Excute the corresponding action
	if((CodeToManage > 0) && (CodeToManage <= thw_drv_adcFdcEvt_menuTabSize)){
		if(thw_drv_adcFdcEvt_menuTab[CodeToManage - 1].pActionFn != NULL)
			thw_drv_adcFdcEvt_menuTab[CodeToManage - 1].pActionFn();
	}
...
//------------------------------------------------------------------------------
/// \fn 		void thw_drv_adcFdcEvt_RefreshFn(void)
/// \brief
//------------------------------------------------------------------------------
void thw_drv_adcFdcEvt_RefreshFn(void)
{
...
//------------------------------------------------------------------------------
/// \fn 		void thw_drv_adcFdcEvt_startStop(void)
/// \brief
//------------------------------------------------------------------------------
static void thw_drv_adcFdcEvt_startStop(void)
{
...
//------------------------------------------------------------------------------
/// \fn 		void thw_drv_adcFdcEvt_toggleVref(void)
/// \brief
//------------------------------------------------------------------------------
static void thw_drv_adcFdcEvt_toggleVref(void)
{
...
//------------------------------------------------------------------------------
/// \fn 		void thw_drv_adcFdcEvt_toggleDepExt1(void)
/// \brief
//------------------------------------------------------------------------------
static void thw_drv_adcFdcEvt_toggleDepExt1(void)
{
...
//------------------------------------------------------------------------------
/// \fn 		void thw_drv_adcFdcEvt_toggleDepExt2(void)
/// \brief
//------------------------------------------------------------------------------
static void thw_drv_adcFdcEvt_toggleDepExt2(void)
{
...
//------------------------------------------------------------------------------
/// \fn 		void thw_drv_adcFdcEvt_toggleDepInt(void)
/// \brief
//------------------------------------------------------------------------------
static void thw_drv_adcFdcEvt_toggleDepInt(void)
{
...
//------------------------------------------------------------------------------
/// \fn 		void thw_drv_adcFdcEvt_toggleTempExt1(void)
/// \brief
//------------------------------------------------------------------------------
static void thw_drv_adcFdcEvt_toggleTempExt1(void)
{
